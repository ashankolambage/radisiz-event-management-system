 ...
 * @author Arjuna
 */
public class Event_manager_3 extends javax.swing.JPanel {
    ...
    public Event_manager_3() {
        initComponents();
        loadcombo();
        jLabel12.setText(AllUpcomingEvents.id);
        autofill();
    }
    ...
    private void initComponents() {
        ...
        jPanel4.add(jButton6, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 10, 110, 30));
        ...
        jPanel4.add(jButton11, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 10, 90, 30));

        jButton12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/Arrow-Back-icon.png"))); // NOI18N
        ...
        jPanel4.add(jButton12, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 100, 30));
        ...
        jPanel4.add(jButton7, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 10, 140, 30));

        jPanel1.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 490, 490, 50));
        ...
        jPanel1.add(jScrollPane4, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 140, 630, 130));
        jPanel1.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(850, 40, 150, 20));
        ...
        jPanel1.add(jScrollPane5, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 130, 250, 150));
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        if (iii == 1){
            ...
            sd2 = 1;
            try {
            ResultSet rs = DB.getCon().createStatement().executeQuery("SELECT event_manager_id FROM event_manager WHERE event_manager_id = '"+jLabel12.getText()+"'");
            if (!(rs.next())){
        ...
        try {
            DB.getCon().createStatement().executeUpdate("UPDATE event_manager SET event_charge = '"+jTextField5.getText()+"', total_prise = '"+jTextField3.getText()+"' WHERE event_manager_id = '"+jLabel12.getText()+"'");
            DB.getCon().createStatement().executeUpdate("UPDATE event_details SET total_amount = '"+jTextField3.getText()+"', charge = '"+jTextField5.getText()+"' WHERE event_id = '"+jLabel11.getText()+"'");
            Toolkit.getDefaultToolkit().beep();
        ...
        try {
            DB.getCon().createStatement().executeUpdate("DELETE FROM event_manager_package WHERE idevent_manager_package_id = '"+jLabel12.getText()+"'");
            DB.getCon().createStatement().executeUpdate("DELETE FROM event_manager_component WHERE event_manager_component_id = '"+jLabel12.getText()+"'");
        } catch (Exception e) {
            e.printStackTrace();
        }
        try {
            ...
            if (row != 0){
                while (i < row){
                    ...
                    try {
                        DB.getCon().createStatement().executeUpdate("INSERT INTO event_manager_component VALUES ('"+jLabel12.getText()+"', '"+table[0]+"', '"+table[1]+"', '"+table[2]+"', '"+table[3]+"', '"+table[4]+"')");
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                    i+=1;
            ...
            if (row != 0){
                while (i < row){
                    ...
                    try {
                        DB.getCon().createStatement().executeUpdate("INSERT INTO event_manager_package VALUES ('"+jLabel12.getText()+"', '"+table[0]+"', '"+table[1]+"', '"+table[2]+"', '"+table[3]+"')");
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                    i+=1;
    ...
    private void jPanel1PropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_jPanel1PropertyChange
        ...
        if (jLabel13.isVisible()){
            s22 = jLabel13.getText();
        }else{
            s22 = jLabel14.getText();
        }
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        Reports.Get_pass_note.jTextField2.setText(jLabel12.getText());
        Map mm = new HashMap();
    ...
    private void autofill() {
        jLabel12.setText(AllUpcomingEvents.id);
        try {
            ResultSet rs = DB.getCon().createStatement().executeQuery("SELECT * FROM event_manager_component WHERE event_manager_component_id = '"+jLabel12.getText()+"'");
            DefaultTableModel dtm = (DefaultTableModel) jTable3.getModel();
            while (rs.next()){
                Vector v = new Vector();
                v.add(rs.getString("item_name"));
        ...
        try {
            DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel();
            ResultSet rs =  DB.getCon().createStatement().executeQuery("SELECT * FROM event_manager_package WHERE idevent_manager_package_id = '"+jLabel12.getText()+"'");
            while (rs.next()){
                Vector v = new Vector();
        ...
        try {
            jTextField5.setText("");
            ResultSet rs =  DB.getCon().createStatement().executeQuery("SELECT event_charge,total_prise FROM event_manager WHERE event_manager_id = '"+jLabel12.getText()+"'");
            while (rs.next()){
        ...
        try {
            ResultSet rs =  DB.getCon().createStatement().executeQuery("SELECT * FROM event_details WHERE event_id = '"+jLabel12.getText()+"'");
            while (rs.next()){
