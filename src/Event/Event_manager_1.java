 ...
 * @author Arjuna
 */
public class Event_manager_1 extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jButton6.setText("Get Pass Note");
        jButton6.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton6ActionPerformed(evt);
            }
        });
        jPanel4.add(jButton6, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 10, 150, 30));

        jButton10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/Arrow-Back-icon.png"))); // NOI18N
        ...
        jPanel4.add(jButton10, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 100, 30));
        ...
        jPanel4.add(jButton11, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 10, 90, 30));

        jButton12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/1406203781_meanicons_24.png"))); // NOI18N
        ...
        jPanel4.add(jButton12, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 10, 90, 30));

        jPanel1.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 490, 480, 50));

        jLabel10.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel10.setText("Item ID");
        jPanel1.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 110, -1, -1));
        ...
        jPanel1.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(850, 40, 150, 20));
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(880, 280, 110, -1));
        ...
        jPanel1.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 450, 110, -1));

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel1.setText("Event Date From :");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 40, -1, 20));
        jPanel1.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 40, 150, 20));

        jLabel15.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel15.setText("Event Date To :");
        jPanel1.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 40, -1, 20));
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        ...
        try {
            ResultSet rs = DB.getCon().createStatement().executeQuery("SELECT event_manager_id FROM event_manager WHERE event_manager_id = '"+jLabel11.getText()+"'");
            if (!(rs.next())){
                DB.getCon().createStatement().executeUpdate("INSERT INTO event_manager (event_manager_id) VALUES ('"+jLabel11.getText()+"')");
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
        try {
            DB.getCon().createStatement().executeUpdate("UPDATE event_manager SET event_charge = '"+jTextField5.getText()+"', total_prise = '"+jTextField3.getText()+"' WHERE event_manager_id = '"+jLabel11.getText()+"'");
            DB.getCon().createStatement().executeUpdate("UPDATE event_details SET total_amount = '"+jTextField3.getText()+"'");
        } catch (Exception e) {
            e.printStackTrace();
        }
        
        try {
            DB.getCon().createStatement().executeUpdate("DELETE FROM event_manager_package WHERE idevent_manager_package_id = '"+jLabel11.getText()+"'");
            DB.getCon().createStatement().executeUpdate("DELETE FROM event_manager_component WHERE event_manager_component_id = '"+jLabel11.getText()+"'");
        } catch (Exception e) {
            e.printStackTrace();
        }
        try {
            ...
            if (row != 0){
                while (i < row){
                    ...
                    try {
                        DB.getCon().createStatement().executeUpdate("INSERT INTO event_manager_component VALUES ('"+jLabel11.getText()+"', '"+table[0]+"', '"+table[1]+"', '"+table[2]+"', '"+table[3]+"', '"+table[4]+"')");
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                    i+=1;
            ...
            if (row != 0){
                while (i < row){
                    ...
                    try {
                        DB.getCon().createStatement().executeUpdate("INSERT INTO event_manager_package VALUES ('"+jLabel11.getText()+"', '"+table[0]+"', '"+table[1]+"', '"+table[2]+"', '"+table[3]+"')");
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                    i+=1;
        ...
        sd2 = 1;
        sss = jLabel11.getText();
        jPanel1.removeAll();
        GroupLayout layout = new GroupLayout(jPanel1);
        jPanel1.setLayout(layout);
        Deal_event_register dii = new Deal_event_register();
        layout.setHorizontalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(dii, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE));
        layout.setVerticalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(dii, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE));
    ...
    private void jButton12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton12ActionPerformed
        ...
        if (i == 0){
            ...
            ResultSet rs = DB.getCon().createStatement().executeQuery("SELECT event_manager_id FROM event_manager WHERE event_manager_id = '"+jLabel11.getText()+"'");
            if (rs.first()){
                rs = DB.getCon().createStatement().executeQuery("SELECT event_customer_details_reg_no FROM event_details WHERE event_customer_details_reg_no = '"+Deal_event_register.cu_id+"' AND event_id != '"+jLabel11.getText()+"'");
                if (!(rs.first())){
                    DB.getCon().createStatement().executeUpdate("DELETE FROM event_manager_component WHERE event_manager_component_id = '"+jLabel11.getText()+"'");
                    DB.getCon().createStatement().executeUpdate("DELETE FROM event_manager_package WHERE idevent_manager_package_id = '"+jLabel11.getText()+"'");
                    DB.getCon().createStatement().executeUpdate("DELETE FROM event_manager WHERE event_manager_id = '"+jLabel11.getText()+"'");
                    DB.getCon().createStatement().executeUpdate("DELETE FROM event_details WHERE event_id = '"+jLabel11.getText()+"'");
                ...
                if (!(rs.first())){
                    DB.getCon().createStatement().executeUpdate("DELETE FROM event_details WHERE event_id = '"+jLabel11.getText()+"'");
                    DB.getCon().createStatement().executeUpdate("DELETE FROM event_customer_details WHERE reg_no = '"+Deal_event_register.cu_id+"'");
                }else{
                    DB.getCon().createStatement().executeUpdate("DELETE FROM event_details WHERE event_id = '"+jLabel11.getText()+"'");
                }
            }
    ...
    private void jTextField7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTextField7MouseClicked
        ...
        if (qt1 == 0) {
            ...
            if (qt1 == 0){
                Toolkit.getDefaultToolkit().beep();
                JOptionPane.showMessageDialog(RootPanel, "Stock s Empty", "Informaton", JOptionPane.INFORMATION_MESSAGE);
            }else{
                Toolkit.getDefaultToolkit().beep();
                JOptionPane.showMessageDialog(RootPanel, "Stock Have Only "+qt1+" Items", "Informaton", JOptionPane.INFORMATION_MESSAGE);
            }
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        Reports.Get_pass_note.jTextField2.setText(jLabel11.getText());
        Map mm = new HashMap();
    ...
    private void autofill() {
        jLabel11.setText(Deal_event_register.ev_id);
        try {
            DefaultTableModel dtm = (DefaultTableModel) jTable3.getModel();
            dtm.setRowCount(0);
            ResultSet rs = DB.getCon().createStatement().executeQuery("SELECT * FROM event_manager_component WHERE event_manager_component_id = '"+Deal_event_register.ev_id+"'");
            while (rs.next()){
                Vector v = new Vector();
                v.add(rs.getString("item_name"));
                v.add(rs.getString("item_id"));
        ...
        try {
            DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel();
            dtm.setRowCount(0);
            ResultSet rs =  DB.getCon().createStatement().executeQuery("SELECT * FROM event_manager_package WHERE idevent_manager_package_id = '"+Deal_event_register.ev_id+"'");
            while (rs.next()){
                Vector v = new Vector();
        ...
        try {
            ResultSet rs =  DB.getCon().createStatement().executeQuery("SELECT * FROM event_details WHERE event_id = '"+Deal_event_register.ev_id+"'");
            while (rs.next()){
        ...
        try {
            jTextField5.setText("");
            ResultSet rs =  DB.getCon().createStatement().executeQuery("SELECT event_charge,total_prise FROM event_manager WHERE event_manager_id = '"+Deal_event_register.ev_id+"'");
            while (rs.next()){
        ...
        try {
            ResultSet rs = DB.getCon().createStatement().executeQuery("SELECT name FROM inventory_packages WHERE state = 'Not_Remove'");
            while (rs.next()){
